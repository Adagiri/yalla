...
export const mfaEnabledTemplate = (): string => 'Multi-Factor Authentication (MFA) has been successfully enabled on your account. If you didn\'t perform this action, please contact support immediately.';
